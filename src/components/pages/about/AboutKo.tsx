      ...
      sections={[
        {
          ...
          children: (
            <>
              ...
              <ul>
                <li>스크린샷을 최대 16장까지 추가하고 순서를 바꿀 수 있습니다. 3×3·4×4 격자는 각각 9장·16장을 사용합니다.</li>
        ...
        },
        {
          ...
          children: (
            <FeatureCoverageTable
              ...
              notesLabel="사용 기준"
              rows={[
                { area: '입력 이미지', support: 'PNG · JPG · WebP', notes: '한 장 50MB 이하, 사진 최대 16장. 큰 이미지는 브라우저에서 편집용으로 최적화될 수 있습니다.' },
                { area: '레이아웃', support: '가로 분할 · 세로 분할 · 바둑판 · 3×3 · 4×4', notes: '일반 바둑판은 3~4장, 3×3·4×4 격자는 각각 9장·16장을 사용하며 자동·16:9·2:1 비율과 간격·테두리·배경을 조정합니다.' },
