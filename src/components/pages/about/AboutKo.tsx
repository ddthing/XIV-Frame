...
export function AboutKo() {
  return (
    <Container size="sm" className="py-12 lg:py-24">
      <h1 className="text-5xl lg:text-6xl font-normal tracking-tight mb-8 text-foreground">소개</h1>
      <div className="prose dark:prose-invert prose-lg max-w-none">
        <h2 className="text-2xl font-normal tracking-tight text-foreground">우리의 미션</h2>
        <p className="text-muted-foreground leading-relaxed">
          XIV Frame은 파이널판타지14 플레이어를 위한 프리미엄 스크린샷 프레임 제작 도구입니다. 복잡한 사진 편집 프로그램 없이 브라우저에서 몇 번의 클릭만으로 멋진 스크린샷을 연출할 수 있습니다.
        </p>
        <h2 className="text-2xl font-normal tracking-tight text-foreground">오픈 소스</h2>
        <p className="text-muted-foreground leading-relaxed">
