...
export function TermsKo() {
  return (
    <Container size="sm" className="py-12">
      <h1 className="text-4xl font-normal tracking-tight mb-8 text-foreground">이용약관</h1>
      <div className="prose dark:prose-invert">
        <h2 className="text-2xl font-normal tracking-tight">서비스 이용</h2>
        <p className="mb-4">XIV Frame은 파이널판타지14 스크린샷 프레임 꾸미기를 목적으로 제공되는 무료 웹 서비스입니다.</p>
        <h2 className="text-2xl font-normal tracking-tight">면책 조항</h2>
