      ...
      sections={[
        {
          ...
          children: (
            <>
              <p>XIV Frame은 파이널판타지14 스크린샷을 브라우저에서 구성하고 결과 파일로 저장할 수 있도록 제공되는 무료 웹 도구입니다. PNG를 우선 저장하지만, 5MB를 넘는 불투명 결과는 고화질 JPEG로 자동 최적화될 수 있습니다. 현재 회원가입, 로그인, 유료 플랜, 서버 기반 프로젝트 보관 기능은 제공하지 않습니다.</p>
