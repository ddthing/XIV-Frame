      ...
      sections={[
        {
          ...
          children: (
            <>
              <p>XIV Frameは、ファイナルファンタジーXIVのスクリーンショットをブラウザで構成し、結果ファイルとして保存できる無料のウェブツールです。PNGを優先しますが、5MBを超える不透明な結果は高画質JPEGへ自動最適化される場合があります。現在、アカウント、ログイン、有料プラン、サーバー上のプロジェクト保存機能は提供していません。</p>
