...
export function TermsJa() {
  return (
    <Container size="sm" className="py-12">
      <h1 className="text-4xl font-normal tracking-tight mb-8 text-foreground">利用規約</h1>
      <div className="prose dark:prose-invert">
        <h2 className="text-2xl font-normal tracking-tight">サービスの利用</h2>
        <p className="mb-4">XIV Frameは、ファイナルファンタジーXIVのスクリーンショットを装飾する目的で提供される無料のウェブサービスです。</p>
        <h2 className="text-2xl font-normal tracking-tight">免責事項</h2>
