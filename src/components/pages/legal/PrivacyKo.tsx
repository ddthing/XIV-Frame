...
export function PrivacyKo() {
  return (
    <Container size="sm" className="py-12">
      <h1 className="text-4xl font-normal tracking-tight mb-8 text-foreground">개인정보처리방침</h1>
      <div className="prose dark:prose-invert">
        <h2 className="text-2xl font-normal tracking-tight">수집하는 개인정보</h2>
        <p className="mb-4">XIV Frame은 회원가입을 요구하지 않으며, 서버에 이미지를 업로드하거나 저장하지 않습니다. 모든 이미지 처리 및 파일 다운로드는 사용자의 브라우저(클라이언트) 내부에서만 이루어집니다.</p>
        <h2 className="text-2xl font-normal tracking-tight">쿠키 및 로컬 스토리지</h2>
        <p className="mb-4">사용자의 편의를 위해 설정 내역(언어, 레이아웃 옵션 등)은 브라우저의 로컬 스토리지에 임시 저장될 수 있습니다.</p>
        <h2 className="text-2xl font-normal tracking-tight">문의</h2>
