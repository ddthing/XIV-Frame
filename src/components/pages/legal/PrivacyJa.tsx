...
export function PrivacyJa() {
  return (
    <Container size="sm" className="py-12">
      <h1 className="text-4xl font-normal tracking-tight mb-8 text-foreground">プライバシーポリシー</h1>
      <div className="prose dark:prose-invert">
        <h2 className="text-2xl font-normal tracking-tight">収集する個人情報</h2>
        ...
        <h2 className="text-2xl font-normal tracking-tight">クッキーとローカルストレージ</h2>
        <p className="mb-4">お客様の利便性のため、設定（言語、レイアウトオプションなど）はお使いのブラウザのローカルストレージに一時的に保存される場合があります。</p>
        <h2 className="text-2xl font-normal tracking-tight">お問い合わせ</h2>
