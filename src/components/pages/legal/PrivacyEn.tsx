...
export function PrivacyEn() {
  return (
    <Container size="sm" className="py-12">
      <h1 className="text-4xl font-normal tracking-tight mb-8 text-foreground">Privacy Policy</h1>
      <div className="prose dark:prose-invert">
        <h2 className="text-2xl font-normal tracking-tight">Information Collection</h2>
        ...
        <h2 className="text-2xl font-normal tracking-tight">Cookies and Local Storage</h2>
        ...
        <h2 className="text-2xl font-normal tracking-tight">Contact</h2>
