...
export function ContactJa() {
  return (
    <Container size="sm" className="py-12 lg:py-24">
      <h1 className="text-5xl lg:text-6xl font-normal tracking-tight mb-8 text-foreground">お問い合わせ</h1>
      <div className="prose dark:prose-invert prose-lg max-w-none">
        <h2 className="text-2xl font-normal tracking-tight text-foreground">連絡先</h2>
