    ...
    <div className="flex gap-1 font-sans" role="group" aria-label={t('align')}>
      {ALIGN_OPTIONS.map(({ value: optVal, label, icon }) => (
        <button
          ...
          className={`flex min-h-11 flex-1 items-center justify-center rounded-md border transition-all shadow-subtle focus-visible:outline-none focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/60 focus-visible:ring-offset-1 focus-visible:ring-offset-background
            ${value === optVal
