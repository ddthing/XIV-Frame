...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const description = locale === 'ko'
    ? 'XIV Frame의 이미지 추가, 레이아웃, 합성·배경 제거, 시그니처, 결과 저장과 파일·게시 전 문제 해결 방법을 확인하세요.'
    : locale === 'ja'
      ? 'XIV Frameの画像追加、レイアウト、合成・背景削除、署名、結果の保存と公開前の確認方法を説明します。'
      : 'Find answers about images, layouts, compositing, background removal, signatures, result export, and publishing checks.'
