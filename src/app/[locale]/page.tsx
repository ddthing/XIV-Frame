...
export async function generateMetadata({ params }: { params: { locale: string } }): Promise<Metadata> {
  ...
  let description = "파이널판타지14 스크린샷을 최대 16장까지 구성하고, 합성·시그니처·레이아웃을 브라우저에서 조정해 결과 파일로 저장하는 무료 편집 도구입니다.";
  
  if (locale === 'en') {
    title = "XIV Frame - FF14 Screenshot Framer";
    description = "Compose up to 16 Final Fantasy XIV screenshots, including 3×3 and 4×4 grids, add composite elements and signatures, and save the result in your browser.";
  } else if (locale === 'ja') {
    title = "XIV Frame - FF14 スクリーンショットフレーマー";
    description = "最大16枚のFF14スクリーンショットを配置し、3×3・4×4グリッドや合成素材、署名を調整してブラウザで結果を保存できます。";
  }
