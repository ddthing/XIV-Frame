...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const description = isJapanese
    ? '最大16枚のFFXIVスクリーンショットを配置し、3×3・4×4グリッド、合成・レイアウト・署名を調整して結果ファイルを保存できる無料のブラウザエディターです。'
    : 'A free browser editor for arranging up to 16 Final Fantasy XIV screenshots, including 3×3 and 4×4 grids, tuning composites and signatures, and saving the finished result.'
